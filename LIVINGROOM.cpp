...
void CreateRoom()
{
	...
	//parete NORD
	//fiori 1
	livingroom.wall1.onWall[0].setObjectName("fiori");
	livingroom.wall1.onWall[0].setRoomPosition(getRoomNumber());
	livingroom.wall1.onWall[0].setWallPosition(1);
	livingroom.wall1.onWall[0].setUsed("nasconde la graffetta");
	livingroom.wall1.onWall[0].setEffect("fornisce la graffetta se la si usa")
	//graffetta 2
	livingroom.wall1.onWall[1].setObjectName("graffetta");
	livingroom.wall1.onWall[1].setRoomPosition(getRoomNumber());
	...
	livingroom.wall1.onWall[2].setRoomPosition(getRoomNumber());
	...
	livingroom.wall1.onWall[3].setRoomPosition(getRoomNumber());
	...
	livingroom.wall1.onWall[4].setRoomPosition(getRoomNumber());
