...
void CreateRoom()
{
	...
	bedroom.wall1.onWall[0].setRoomPosition(getRoomNumber());
	...
	bedroom.wall1.onWall[1].setRoomPosition(getRoomNumber());
	...
	bedroom.wall1.onWall[2].setRoomPosition(getRoomNumber());
	...
	bedroom.wall1.onWall[3].setRoomPosition(getRoomNumber());
	...
	bedroom.wall1.onWall[4].setRoomPosition(getRoomNumber());
	...
	bedroom.wall2.onWall[0].setRoomPosition(getRoomNumber());
	...
	bedroom.wall2.onWall[1].setRoomPosition(getRoomNumber());
	...
	bedroom.wall2.onWall[2].setRoomPosition(getRoomNumber());
	...
	bedroom.wall2.onWall[3].setRoomPosition(getRoomNumber());
	...
	bedroom.wall2.onWall[4].setRoomPosition(getRoomNumber());
	...
	bedroom.wall3.onWall[0].setRoomPosition(getRoomNumber());
	...
	bedroom.wall3.onWall[1].setRoomPosition(getRoomNumber());
	...
	bedroom.wall3.onWall[2].setRoomPosition(getRoomNumber());
	...
	bedroom.wall3.onWall[3].setRoomPosition(getRoomNumber());
	...
	bedroom.wall3.onWall[4].setRoomPosition(getRoomNumber());	//serve per confondere
	...
	bedroom.wall4.onWall[0].setRoomPosition(getRoomNumber());
	...
	bedroom.wall4.onWall[1].setRoomPosition(getRoomNumber());
	...
	bedroom.wall4.onWall[2].setRoomPosition(getRoomNumber());
	...
	bedroom.wall4.onWall[4].setRoomPosition(getRoomNumber());
	...
	bedroom.wall5.onWall[0].setRoomPosition(getRoomNumber());
	...
	bedroom.wall5.onWall[1].setRoomPosition(getRoomNumber());
	...
	bedroom.wall5.onWall[2].setRoomPosition(getRoomNumber());
	...
	bedroom.wall5.onWall[3].setRoomPosition(getRoomNumber());
	...
	bedroom.wall5.onWall[4].setRoomPosition(getRoomNumber());	//serve per confondere
